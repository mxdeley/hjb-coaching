      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                ...
                it&apos;s really you. Please enter the following verification code when prompted. If
          ...
          <Text style={footerText}>
            ...
            North, Seattle, WA 98109. © 2022, Amazon Web Services, Inc.. All rights reserved. AWS
